...
const linkfolio_data = {
  ...
  features: [
    'Linkfolio utilizes Firebase for its authentication, database for data, and storage for storing images of the of the users portfolio website for their post. ',
  ...
  return (
    <>
      ...
      <main className='mt-[80px] grid grid-cols-6'>
        <FullProjectSection data={linkfolio_data} />
        <ExploreMore
          previous={linkfolio_data.last}
          next={linkfolio_data.next}
        />
      </main>
    </>
  );
